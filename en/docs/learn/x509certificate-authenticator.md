...
2.  Add the following configuration to the file.
    ...
    1.  `            authentication_endpoint           ` : This is the
        ...
        . This value will be taken to extract the certificate from the browser by redirecting the user to the 
        specified endpoint. Update this based on your host name.
