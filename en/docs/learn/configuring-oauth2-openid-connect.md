...
5.  Fill in the following fields where relevant.
    ...
    | Userinfo Endpoint URL           | This is the standard OIDC Userinfo Endpoint URL of the federated IDP.                                                                                                                                                                | <https://localhost:9443/oauth2/userinfo>   |
    | Logout Endpoint URL             | This is the standard OIDC RP Initiated Logout Endpoint URL of the federated IDP.                                                                                                                                                     | <https://localhost:9443/oidc/logout>       |
