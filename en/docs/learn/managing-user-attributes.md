...
2.  You can use the REST Web service according to the SCIM provisioning specification. For more information on this, see [SCIM 2.0 REST APIs](../../develop/scim2-rest-apis/).
