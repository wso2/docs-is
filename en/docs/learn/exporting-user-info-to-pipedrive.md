...
activities and monitor deals. This topic provides instructions on exporting user data from WSO2 Identity Server (WSO2 IS) 
to Pipedrive CRM. 
...
4. Click **From a spreadsheet** and upload the created **users.csv** file with exported user data.
...
7. Finally, click on **Start Import**.
