...
1.  Follow the steps
    ...
    to download,
    [deploy](../../develop/deploying-the-sample-app/#deploy-the-sample-web-app)
    and [register](../../develop/deploying-the-sample-app/#deploy-the-sample-web-application) `playground2` application.
