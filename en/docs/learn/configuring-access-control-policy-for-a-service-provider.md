...
!!! Tip "Deploy the Sample Application"
    Follow [these steps to deploy and configure](../../develop/deploying-the-sample-app/#deploying-travelocity-webapp) the `travelocity.com` sample application.
...
6.  Configure an inbound authentication protocol for the service
    ...
    !!! info "Configure travelocity"
		...
		by following the instructions in [Deploying the Sample App](../../develop/deploying-the-sample-app/#deploying-travelocity-webapp). 
