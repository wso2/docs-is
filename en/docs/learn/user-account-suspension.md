...
3.  Expand the **Account Locking** tab and select the **Account Lock
    ...
    |--------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
    | Account Lock Enabled | This specifies the account locking for failed logins.                                                                                                                                                                                                                                         |            |
    | Maximum Failed Login Attempts | This specifies the number of failed attempts allows without locking the account.                                                                                                                                                                                                                                      | 5           |
    | Lock Unlock time | This specifies the account locked time span in minutes.                                                                                                                                                                                                                                          | 5           |
    ...
    | Enable Notification Internally Management | The feild is set false if the client application handles notification sending.                                                                                                                                                                                                                                           |            |
