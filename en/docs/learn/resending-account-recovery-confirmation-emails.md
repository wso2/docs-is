...
!!! tip
    For information on the REST API for resending confirmation code, see [Resend-Code Using REST API](https://docs.wso2.com/apidocs/is/is590/self-registration/#!/operations#ResendConfirmation#resendCodePost).
