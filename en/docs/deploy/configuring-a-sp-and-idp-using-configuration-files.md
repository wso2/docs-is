...
!!! note
    The above processes can be easily done using the [Management Console](../../../deploy/get-started/getting-started-with-the-management-console/), but the
...
1.  [Start the `identity provider IS` and access the Management Console](../../../deploy/get-started/running-the-product/).
