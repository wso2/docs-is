...
<td>The name of the database.</td>
 ...
 A sample configuration is given below.
   ...
   3. If you have a requirement in using workflow feature follow, 
       [Changing the default database of BPS database](../../../deploy/change-datasource-bpsds)
...
!!! info 
    ...
    see [Tomcat JDBC Connection Pool](http://tomcat.apache.org/tomcat-9.0-doc/jdbc-pool.html#Tomcat_JDBC_Enhanced_Attributes).
