...
!!! tip 
    Refer [Configuring userstores](../../../deploy/configuring-user-stores) to get a high-level understanding of the userstores available in WSO2 Identity Server (WSO2 IS).
...
[Working With Databases](../../../deploy/working-with-databases).
...
##Configure an external database as JDBC userstore. 
  ...
  1. Create a database on [any supported RDBMS database](../../../deploy/working-with-databases). 
