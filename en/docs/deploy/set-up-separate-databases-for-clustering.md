...
.</li>
<li>For more information, see <a href="../../../deploy/configure-user-stores">Configuring User Stores</a>.</li>
</td>
</tr>
<tr class="even">
...
<li>For more information, see <a href="../../../deploy/change-datasource-bpsds">Changing the Default Datasource 
for BPS</a>.</li>
</td>
</tr>
<tr class="odd">
...
In a deplyment both identity and UMA can be seperated for a single database while consent data is configured to a seperate 
database.</li>
<li>For more information, see <a href="../../../deploy/change-datasource-consent-management">Changing the Default Datasource for 
