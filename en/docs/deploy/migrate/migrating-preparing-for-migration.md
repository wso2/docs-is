...
With WSO2 Identity Server 5.11.0, groups and roles are separated. For more information, see [What Has Changed in 5.11.0](../../../deploy/migrate/migrating-what-has-changed#group-and-role-separation).
...
[What Has Changed](../../../deploy/migrate/migrating-what-has-changed) to do the configuration migration.
...
!!! info
    ...
    next section, [Migrating to 5.11.0](../../../deploy/migrate/migrating-to-5110).
...
10. Proceed to the next section [Migrating to 5.11.0](../../../deploy/migrate/migrating-to-5110).
