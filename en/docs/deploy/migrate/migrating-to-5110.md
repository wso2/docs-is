...
2.  Carry out the pre-processing steps in [Preparing for migration](../../../deploy/migrate/migrating-preparing-for-migration).
...
1.  If you have manually added any custom OSGI bundles to the
    ...
    !!! warning "Important" 
        ...
        Refer [Migrating custom components](../../../deploy/migrate/migrating-preparing-for-migration/#migrate-custom-components).
...
6. Ensure that you have migrated the configurations into the new version as
   advised in [preparing for migration section.](../../../deploy/migrate/migrating-preparing-for-migration/#migrate-the-configurations)
...
!!! warning
    Proceed with this step only if you have opted in for [Zero down time migration](../../../deploy/migrate/migrating-preparing-for-migration/#zero-downtime-migration).
...
!!! tip
    If the id token validation for the **Console** and **My Account** applications are failing, see [Validation of issuer in .well-known endpoint URL](../../../deply/migrate/migrating-what-has-changed/#validation-of-issuer-in-well-known-endpoint-url).
