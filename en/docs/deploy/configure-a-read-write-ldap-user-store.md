...
WSO2 identity server uses embedded H2 database as the primary userstore. This document will guide you to change that to a Read/Write LDAP userstore.
...
<td><p>Connection URL to the userstore server.</p>
<p>Sample values:<br />
