...
<ul>
<li>WSO2 Identity Server requires an Oracle JDK 17 or JDK 11 compliant JDK. This will run on most common platforms that <strong>support Java 17 or Java 11.</strong> .</li>
