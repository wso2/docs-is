...
!!! note  
    ...
    Patch logs, and Service/Event logs. For more information, see [Monitor WSO2 Identity Server](../../../deploy/monitor/monitoring-the-identity-server).
---
...
See [Work with Product Observability](../../../deploy/monitor/working-with-product-observability) for instructions on
