...
custom federated authenticator, see [Writing a Custom Federated Authenticator](../../develop/extend/writing-a-custom-federated-authenticator/).
...
Connector](../../../develop/extend/writing-an-outbound-provisioning-connector/).
