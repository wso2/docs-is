...
!!! note
    These configurations work with 2.0.9 to 2.0.12 version of the
...
3.  Add the following configurations in the
    ...
    <td>The backup code is used instead of the actual SMS code. The value can be <code>                                   true                                 </code> or <code>                                   false                                 </code> . If you do not want backup codes, set this as <code>                                                      false                                                   </code> . You can skip the steps 6.a and 7 in the <a href="#configuring-claims">Configuring claims section.</a> <code>                </code>
    </td>
    </tr>
    <tr class="odd">
...
1.  Download the WSO2 Identity Server from
    ...
    [run it](../../setup/running-the-product).
