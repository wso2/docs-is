...
-   All WSO2 products are generally compatible with most common DBMSs.
    ...
    information, see [Working with Databases](../../administer/working-with-databases). Also, we do not recommend the H2
...
-   **Set the properties from an external registry**. If you want to
    ...
    code and secure the properties file with the [secure vault](../../administer/../../administer/carbon-secure-vault-implementation).
...
Logs](../../administer/monitoring-logs-using-management-console-using-management-console).
...
<li>See <a href="../../administer/working-with-properties-of-user-stores">Working with Transports</a> for information on transports in WSO2 products.</li>
</ul>
</div>
</div>
</div></td>
...
<li>See <a href="../../administer/security-guidelines-for-production-deployment">Separating the Worker and Manager Nodes</a> for information on clustering WSO2 products by separating worker and manager concerns between the nodes.</li>
</ul>
</div>
</div>
</div></td>
