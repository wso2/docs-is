...
1](Deployment-Patterns-103329471.html#DeploymentPatterns-Pattern1-HAclustereddeploymentofWSO2IdentityServer)
.
...
1.  Create the databases. See [Setting up the Physical
    ...
    !!! tip
        ...
        Clustering](../../setup/setting-up-separate-databases-for-clustering) topic.
