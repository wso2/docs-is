...
<li>See <a href="../../administer/capturing-system-data-in-error-situations">Monitoring WSO2 products</a> for information on the monitoring options for WSO2 products.</li>
</ul></td>
</tr>
<tr class="even">
