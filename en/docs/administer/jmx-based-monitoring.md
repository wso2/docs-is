...
You can disable the JMX server for your product by setting
...
instructions on [Installing the JDK](https://docs.oracle.com/javase/7/docs/webnotes/install/index.html) for more information.
