...
With symmetric encryption, a single key will be shared for encryption and decryption of information. From WSO2 Identity Server 5.11.0 onwards, symmetric encryption is used by default. You can switch to [asymmetric key encryption](../../administer/using-asymmetric-encryption) if required.
...
!!! info
	For more information on how to configure the properties related to symmetric key encryption, see [Configurations Related to Symmetric Key Encryption](../../administer/using-symmetric-encryption).