...
This page guides you through using [OpenID Connect Discovery](insertlink) to discover an end user's OpenID provider, and to obtain information required to interact with the OpenID provider, including its OAuth 2.0 endpoint locations. 
