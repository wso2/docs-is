...
[Device Authorization Grant](../../references/concepts/authorization/device-flow-grant).
...
3. On the **Main** menu, click **Service Providers** > **Add**.
    ...
    ![register-service-provider](../assets/img/guides/device-flow/register-service-provider.png)

4. Provide a name for your application and click **Register**.
    
    ![register-service-provider-name](../assets/img/guides/device-flow/register-sp-name.png)
...
5. On the screen that follows, expand **Inbound Authentication Configuration**  > **OAuth/OpenID Connect Configuration** and click **Configure**.
    ...
    ![register-service-provider-oauth](../assets/img/guides/device-flow/register-sp-oauth.png)
...
7. Click **Add** to save the service provider configurations. Take note of the generated OAuth client key and client
 secret.
    ...
    ![consumer-key-service-provider-oauth](../assets/img/guides/device-flow/get-oauth-consumer-key.png)
...
2. From a device with no input constraints, access the <code>verification_uri</code> and enter the user code. You can alternatively access the <code>verification_uri_complete</code> link obtained in the response.
    ...
    ![device-code-enter](../assets/img/guides/device-flow/device-code-enter.png)

3. Click **Continue**. If the user code is correct, you will be prompted to enter your credentials.
 
    ![device-username-password](../assets/img/guides/device-flow/device-username-password.png)
...
4. Once you log in successfully, you will be redirected to the configured callback URL of the service provider.
    ...
    ![device-scopes](../assets/img/guides/device-flow/device-scopes.png)
...
6. To validate the token that you received, [use the introspection endpoint](invoke-oauth-introspection-endpoint.md).
