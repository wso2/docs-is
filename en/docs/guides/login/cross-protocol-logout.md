...
7. Enable OIDC back-channel logout and configure `http://localhost.com:8080/pickup-manager/bclogout` as the back-channel logout URL.
8. Click **Add**. Note the **OAuth Client Key** and **Client Secret** that is displayed. You will need these values later on when deploying the sample application.
...
9. Click **Register** to save the changes.
