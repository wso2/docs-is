...
[here]({{base_path}}/develop/extend/provisioning/write-an-outbound-provisioning-connector). Outbound
...
5.  In the **Outbound Provisioning Configuration** section, do the
    ...
    5.  You can also enable [just-in-time
        provisioning]({{base_path}}/guides/identity-lifecycles/jit-workflow/)
