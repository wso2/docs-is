...
??? warning "Disabled password recovery v1 API"
    Password recovery v1 API is diabled by default due to the these security issue. We recommend using the password recovery v2 API to avoid any adverse effects.
