...
2. [Download](https://github.com/wso2/samples-is/releases/download/v4.5.1/saml2-web-app-pickup-manager.com.war) the `saml2-web-app-pickup-manager.com.war` file from the latest release assets.
