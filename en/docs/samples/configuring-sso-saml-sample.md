...
This page guides you through configuring single sign on authentication between two SAML web applications using two **sample applications** called Pickup Dispatch and Pickup Manager. 
