# Password Grant with OAuth Playground

This page guides you through using a **sample Playground application** to try out authentication to an OAuth/OpenID Connect web application using the [Password](insertlink) grant type.
