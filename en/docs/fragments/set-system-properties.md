...
-   **Set the properties from an external registry** : If you want to
    ...
    code and secure the properties file with the [cipher tool](../../security/encrypt-passwords-with-cipher-tool).

You are now ready to [run the product](../run-the-product).