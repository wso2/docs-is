...
3.  Configure the following set of parameters in the user store
...
3.  Login to the admin portal and configure the ` Mapped Attribute
    ` property of the ` http://wso2.org/claims/username ` claim ID that
    is under **Local Dialect** `http://wso2.org/claims` to ` mail
    `.
