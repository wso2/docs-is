...
![architecture-diagram](/assets/img/introduction/architecture-diagram.png)
...
-   [Inbound authenticators](/introduction/architecture/#inbound-authenticators)
-   [Local authenticators](/introduction/architecture/#local-authenticators)
-   [Outbound/federated
    authenticators](/introduction/architecture/#outbound/federated-authenticators)
-   [Multi-option
    authenticators](/introduction/architecture/#multi-option-authenticators)
-   [Multi-factor
    authenticators](/introduction/architecture/#multi-factor-authenticators)
...
<p><img src="/assets/img/introduction/service-provider.png" title = "service providers" alt="service providers"></p>
...
<p><img src="/assets/img/introduction/sp-inbound-authentication.png" title = "service provider inbound authentication" alt = "service provider inbound authentication"></p>
...
<p><img src="/assets/img/introduction/sp-inbound-provisioning.png" title = "service provider inbound provisioning" alt = "service provider inbound provisioning"></p>
</div></td>
</tr>
<tr class="even">
<td>Inbound authentication</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/inbound-authentication.png" title = "inbound authentication" alt = "inbound authentication"></p>
...
<p><img src="/assets/img/introduction/inbound-authentication-request.png" title = "inbound authentication request" alt = "inbound authentication request"></p>
...
<p><img src="/assets/img/introduction/authentication-framework-response.png" title="authentication framework response" alt="authentication framework response"></p>
<p>This response is sent back to the service provider.</p>
<p><img src="/assets/img/introduction/response-to-sp.png" title="inbound authentication response to the service provider" alt="inbound authentication response to the service provider"></p>
</div></td>
</tr>
<tr class="odd">
<td>Authentication framework</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/authentication-framework.png" title="authentication framework" alt="authentication framework"></p>
...
<p><img src="/assets/img/introduction/inbound-authentication-request.png" title="request to the authentication framework" alt="request to the authentication framework"></p>
...
<p><img src="/assets/img/introduction/authentication-framework-request.png" title="request to local or federated authenticators" alt="request to local or federated authenticators"></p>
...
<p><img src="/assets/img/introduction/local-federated-response.png" title="response to the authentication framework" alt="response to the authentication framework"></p>
...
<p><img src="/assets/img/introduction/provisioning-framework.png" title="request to the provisioning framework" alt="request to the provisioning framework"></p>
...
<p><img src="/assets/img/introduction/authentication-framework-to-inbound-authentication.png" title="response to the inbound authentication" alt="response to the inbound authentication"></p>
</div></td>
</tr>
<tr class="even">
<td>Local authenticators</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/local-authenticators.png" title="local authenticators" alt="local authenticators"></p>
...
<p><img src="/assets/img/introduction/in-channel-to-local-authenticator.png" title="request to the local authenticators" alt="request to the local authenticators"></p>
...
<p><img src="/assets/img/introduction/out-channel-to-authentication-framework.png" title="response to the authentication framework" alt="response to the authentication framework"></p>
<p><br/>
</p>
</div></td>
</tr>
...
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/federated-authenticators.png" title="federated authenticators" alt="federated authenticators"></p>
...
<p><img src="/assets/img/introduction/in-channel-to-federated-authenticators.png" title="request to the federated authenticators" alt="request to the federated authenticators"></p>
...
<p><img src="/assets/img/introduction/federated-authenticators-to-authentication-framework.png" title="response to the authentication framework" alt="response to the authentication framework"></p>
</div></td>
</tr>
<tr class="even">
<td>Identity providers</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/identity-providers.png" title="identity providers" alt="identity providers"></p>
...
<p><img src="/assets/img/introduction/federated-authenticators-to-external-applications.png" title="request to external applications" alt="request to external applications"></p>
...
<p><img src="/assets/img/introduction/authentication-framework-to-provisioning-framework.png" title="request to the provisioning framework" alt="request to the provisioning framework"></p>
...
<p><img src="/assets/img/introduction/provisioning-framework-user-store-manager-interaction.png" title="request to the user store manager and response" alt="request to the user store manager and response"></p>
...
<p><img src="/assets/img/introduction/provisioning-framework-to-outbound-provisioning.png" title="passing on the scim and soap requests to outbound provisioning" alt="passing on the scim and soap requests to outbound provisioning"></p>
</div></td>
</tr>
<tr class="even">
...
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/idp-and-sp-configurations.png" title="idp and sp configurations" alt="idp and sp configurations"></p>
...
<p><img src="/assets/img/introduction/idp-and-sp-to-authentication-framework.png" title="idp and sp configurations for authentication activities" alt="idp and sp configurations for authentication activities"></p>
<p><img src="/assets/img/introduction/idp-and-sp-to-provisioning-framework.png" title="idp and sp configurations for provisioning activities" alt="idp and sp configurations for provisioning activities"></p>
</div></td>
</tr>
<tr class="even">
<td>Inbound provisioning</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/inbound-provisioning.png" title="inbound provisioning" alt="inbound provisioning"></p>
...
<p><img src="/assets/img/introduction/service-provider-to-inbound-provisioning.png" title="request to inbound provisioning" alt="request to inbound provisioning"></p>
...
<p><img src="/assets/img/introduction/inbound-provisioning-to-user-store-manager.png" title="request to the user store manager" alt="request to the user store manager"></p>
</div></td>
</tr>
<tr class="odd">
<td>User store manager</td>
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/user-store-manager.png" title="user store manager" alt="user store manager"></p>
...
<p class="admonition-title">Related Links</p>
<ul>
<li>For more information, see <a href="/introduction/user-management-architecture">User Management Architecture</a></li>
...
<p><img src="/assets/img/introduction/provisioning-framework-user-store-manager-interaction.png" title="request to user store manager and response" alt="request to user store manager and response"></p>
<p>The inbound provisioning component sends SCIM and SOAP provisioning requests on to the user store manager.</p>
<p><img src="/assets/img/introduction/inbound-provisioning-to-user-store-manager.png" title="scim and soap requests to user store manager" alt="scim and soap requests to user store manager"></p>
...
<p><img src="/assets/img/introduction/user-store-manager-to-provisioning-framework.png" title="response to provisioning framework" alt="response to provisioning framework"></p>
</div></td>
</tr>
<tr class="even">
<td>Claim manager</td>
...
<td><div class="content-wrapper">
<p><img src="/assets/img/introduction/outbound-provisioning.png" title="outbound provisioning" alt="outbound provisioning" /></p>
...
<p><img src="/assets/img/introduction/provisioning-framework-to-outbound-provisioning.png" title="request to outbound provisioning" alt="request to outbound provisioning"></p>
</div></td>
</tr>
</tbody>
</table>
