...
!!! warning     
    **WSO2 recommends using** **[SCIM 2.0 APIs](../../using-wso2-identity-server/using-the-scim-2.0-rest-apis)** because of the following
    reasons:    
...
!!! warning     
    ...
    OAuth Authentication instead.** For instructions, see [Setting Up Service Provider for Inbound Provisioning](../../using-wso2-identity-server/setting-up-service-provider-for-inbound-provisioning).
