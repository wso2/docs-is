...
3.  Copy the [sync client jar](../assets/attachments/migration/org.wso2.is.data.sync.client-1.0.23.jar) file to the `<SYNC-TOOL-HOME>/repository/components/dropins` directory.
