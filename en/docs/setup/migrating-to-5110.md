...
10. Follow the steps given below to perform database updates:
    ...
    ??? note "If you are using PostgreSQL"
        During the migration, "uuid-ossp" extension is created in the database. To create this extension, the database user should have permission for the '**Superuser**. 
