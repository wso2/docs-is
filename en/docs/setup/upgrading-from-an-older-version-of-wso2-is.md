...
<ol type="1">
   ...
   <ol type="a">
    ...
    <li>Set <code>defaultAutoCommit </code> as <code>'<defaultAutoCommit>false</defaultAutoCommit>'</code> in the <PRODUCT_HOME>/repository/conf/datasources/ directory.
    ...
    <li>Revert back <code>defaultAutoCommit </code> as <code>'<defaultAutoCommit>true</defaultAutoCommit>'</code> in the <PRODUCT_HOME>/repository/conf/datasources/ directory after migration is successful.</li>
