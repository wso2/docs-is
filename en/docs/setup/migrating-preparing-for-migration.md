...
In WSO2 Identity Server 5.11.0 we have introduced groups and role separation. To enable this feature
following DB scripts needs to be executed before starting the migration process. 
