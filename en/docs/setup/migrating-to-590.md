...
!!! note
    Before you follow this section, see [Before you begin](../../setup/migrating-before-you-begin) and [Preparing for 
    migration](../../setup/migrating-preparing-for-migration) sections to read on prerequisites.
