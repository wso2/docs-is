...
#### Defining blocklists for the threads

Certain threads continuously print unnecessary logs. Defining blocklists
prevents the unwanted threads from printing logs thereby improving the
readability of the logs.

Follow the steps below to configure blocklists for threads. 
...
2.  Add the following configuration as a system property.
    ...
    !!! note
        ...
        threads are already a part of the blocklist in the
