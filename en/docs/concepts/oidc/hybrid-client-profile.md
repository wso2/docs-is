...
!!! tip 
    <p>Here, the id\_token is required to have a c\_hash value.</p>
 
    <p>c\_hash is the base64url encoding of the left-most half of a hash of the
    ...
    <p>The c\_hash value is mandatory when an ` id_token ` is
