...
![saml2-fed-authenticator-flow](../../assets/img/tutorials/saml2-fed-authenticator-flow.png)
...
1.  Click **Add** under **Claims** and then click **Add Local Claim**
    ...
    ![configure-saml2-claims](../../assets/img/tutorials/configure-saml2-claims.png)
...
5.  Expand **Inbound Authentication Configuration** and then expand
    **SAML2 Web SSO Configuration**.
    ...
    <p>For example, if you specify " travelocity.com" as the <code>                                               Issuer                                             </code> and " sp1" as the <code>                                               Service Provider Qualifier                                             </code> , the configuration will be registered in WSO2 IS with the value " travelocity.com:<zero-width-space>urn:sp:qualifier:sp1 <code>                       ".                      </code></p>
    ...
    ![sp-config](../../assets/img/tutorials/sp-config.png)
