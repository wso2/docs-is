...
!!! tip
    ...
    -   Follow the steps under the [Try out
        scenario](#QueryingSAMLAssertions-tryOutScenario) section to try out
        an AssertionID request with the travelocity sample application
        **OR**
    -   Follow the steps under the [Querying an
        assertion](#QueryingSAMLAssertions-Queryinganassertion) section for
...
2.  You have to use a custom assertion builder with the capability to
    ...
    `           ExtendedDefaultAssertionBuilder          ` and comment
    out the `           DefaultSAMLAssertionBuilder          ` as seen
    below.
...
3.  To see the created assertions in the WSO2IS H2 database and access
    ...
    !!! tip
        ...
        see [Browsing the H2
        Database](https://docs.wso2.com/display/ADMIN44x/Browsing+the+H2+Database)
...
1.  Follow the steps in the [Configuring WSO2 Identity
    Server](#QueryingSAMLAssertions-configureIS) section to configure
...
5.  To see the created assertions in the WSO2IS H2 database and access
    ...
    for more information on browsing the H2 Database
    ...
    3.  Restart WSO2 Identity Server and access the following URL via
        ...
        !!! tip
                ...
                Tip: If you are logged in to the management console, logout
...
9.  Copy the SAMLID of the created assertion. You can use this ID to
    ...
    ![](attachments/103330809/103330812.png)
...
12. Run the main() method of the class. You will see a generated request
    ...
    **AssertionIDRequest Response** Expand source
