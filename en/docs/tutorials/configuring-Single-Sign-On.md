...
See the following topics for instructions on how to configure the sample
with the WSO2 Identity Server.

-   [Configuring the SSO web
    application](#ConfiguringSingleSign-On-ConfiguringtheSSOwebapplication)
-   [Configuring the service
    provider](#ConfiguringSingleSign-On-Configuringtheserviceprovider)
-   [Configuring Claims](#ConfiguringSingleSign-On-ConfiguringClaims)
-   [Running the sample](#ConfiguringSingleSign-On-Runningthesample)
...
!!! tip
    ...
    -   To ensure you get the full understanding of this tutorial, the
        ...
        make sure to [download the samples](_Downloading_a_Sample_) before
        you begin.
    ...
    -   Install Apache Maven. For more information, see [Installation
        Prerequisites](_Installation_Prerequisites_) .
...
4.  The **Service Providers** screen appears. Copy the content in the
    ...
    [here](Adding-and-Configuring-a-Service-Provider_103329740.html#AddingandConfiguringaServiceProvider-AppCert)
    .
...
7.  Select **Manual Configuration** and register the new service
    ...
    ![](attachments/103330852/112392581.png){width="750"}

    ![](images/icons/grey_arrow_down.png){.expand-control-image} Click
    here for more information on each attribute
    ...
    <td><p>Select <code>                    wso2carbon                   </code></p>
    <p><code>                    In a tenant : Select the Certificate Alias with tenant domain name                                       </code></p></td>
    </tr>
    <tr class="even">
    ...
    <br />
    The default value can be configured in the <code>                   &lt;IS_HOME&gt;/repository/conf/identity/identity.xml                  </code> file, in the <code>                   SSOService                  </code> element with <code>                   SAMLDefaultSigningAlgorithmURI                  </code> tag. If it is not provided, the default algorithm is RSA­SHA 1, at URI ‘ <code>                   http://www.w3.org/2000/09/xmldsig#rsasha1                  </code> ’.</td>
    ...
    <br />
    The default value can be configured in the <code>                   &lt;IS_HOME&gt;/repository/conf/identity/identity.xml                  </code> file, in the <code>                   SSOService                  </code> element with <code>                   SAMLDefaultDigestAlgorithmURI                  </code> tag. If it is not provided the default algorithm is SHA 1, at URI ‘ <code>                   http://www.w3.org/2000/09/xmldsig#sha1                  </code> ’.</td>
    ...
    <td><p>This is used to sign the SAML2 Responses returned after the authentication process is complete.</p>
    <p><br />
    </p></td>
    ...
    <td><p>Leave unchecked for travelocity sample</p></td>
    </tr>
    <tr class="odd">
    ...
    <li><p><strong>returnTo</strong> (optional) - Value of the parameter should be the URL that the user needs to be redirected to after the logout.</p>
    <p>!!! note</p>
        <p>If this parameter is present in the request, the <strong>spEntityID</strong> parameter must also be present.<br />
        Since this needs to be a trusted location, the value that comes with the request must match with one of the assertion consumer URLs or <strong>returnTo</strong> ULRs of the service provider.</p>
