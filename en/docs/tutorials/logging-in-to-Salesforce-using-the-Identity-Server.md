...
-   [Configuring
    Salesforce](#LoggingintoSalesforceusingtheIdentityServer-ConfiguringSalesforce)
-   [Configuring the service
    provider](#LoggingintoSalesforceusingtheIdentityServer-Configuringtheserviceprovider)
-   [Testing the
    configurations](#LoggingintoSalesforceusingtheIdentityServer-Testingtheconfigurations)
-   [Troubleshooting
    guidelines](#LoggingintoSalesforceusingtheIdentityServer-Troubleshootingguidelines)
...
6.  In the form that appears, fill out the following configuration
    ...
    <td><div class="content-wrapper">
    <div id="expander-1024562633" class="expand-container">
    <div id="expander-control-1024562633" class="expand-control">
    ...
    <div id="expander-content-1024562633" class="expand-content">
...
2.  Create a user in Salesforce. This user should have the same
    ...
    4.  Create a user with the same username as the one you created in
        ...
        !!! note
                ...
                **Note** : This is mainly for testing purposes. In a real
...
3.  Access your Salesforce login URL on an incognito or private browser.
    ...
    6.  Copy the URL that is defined for Login URL to access
        Salesforce.  
        ![](attachments/103331333/103331353.png){width="900"}
