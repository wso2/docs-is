...
[Onboard an administrator]({{base_path}}/guides/organization-management/manage-b2b-administration/#onboard-organization-administrators) to the Best Car Mart organization using the values given below.

<table>
    <tr>
        <th>Username</th>
        <td>Enter a username..</br>
            <code>alex</code>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <th>Email Address</th>
        <td>Enter the email address of the user.</br>
            <code>alex@carmart.com</code>
        </td>
    </tr>
    <tr>
        <th>Password</th>
...
1. Login to organization (root).
2. [Register a standard-based application]({{base_path}}/guides/applications/register-standard-based-app/) in your organization (root) with the following settings:
...
Share the <b>Guardio Insurance app</b> with your <b>Best Car Mart</b> sub organization. See instructions on how to [share applications with organizations]({{base_path}}/guides/organization-management/share-applications/).
