...
2. Click **Create Connection** and select **Custom Authenticator (Plugin-based)**.
...
{% include "../../../../../../includes/guides/fragments/add-login/standard-based-login/add-ws-federation.md" %}

## Configure user attributes

{% include "../../../../../../includes/guides/fragments/manage-connection/manage-attributes.md" %}
