...
!!! abstract ""
    **Example**
    ...
    Follow the instructions given below to set the newly added key as the [symmetric encryption key for CipherTool](../encrypt-passwords-with-cipher-tool.md/#using-symmetric-encryption):
