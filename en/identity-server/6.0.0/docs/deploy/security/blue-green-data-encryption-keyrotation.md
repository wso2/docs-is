...
3.  Create a copy of the `<OLD_IS_HOME>`(This copied directory will be refered to as the `NEW_IS_HOME`) and dump `<OLD_IS_HOME>` identity and registry databases and create the new databases.
