# Removing References to Deleted User Identities in WSO2 Products
...
!!! abstract "Note"
    Since WSO2 Identity Server 5.5.0 the Identity Anonymization tool is
    packaged in the product distribution by default. 
