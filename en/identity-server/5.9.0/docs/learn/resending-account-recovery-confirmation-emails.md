...
!!! tip
<<<<<<<< HEAD:en/identity-server/5.11.0/docs/learn/resending-account-recovery-confirmation-emails.md
...
========
========
>>>>>>>> 5.9.0-docs-old:en/identity-server/5.9.0/docs/learn/resending-account-recovery-confirmation-emails.md
