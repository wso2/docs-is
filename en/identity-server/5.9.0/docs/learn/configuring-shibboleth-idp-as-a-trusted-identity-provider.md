...
<<<<<<<< HEAD:en/identity-server/5.11.0/docs/learn/configuring-shibboleth-idp-as-a-trusted-identity-provider.md
...
========
========
>>>>>>>> 5.9.0-docs-old:en/identity-server/5.9.0/docs/learn/configuring-shibboleth-idp-as-a-trusted-identity-provider.md
