...
<<<<<<<< HEAD:en/identity-server/5.11.0/docs/administer/mitigating-cross-site-request-forgery-attacks.md
...
========
    For WSO2 Identity Server, the configurations for mitigating CSRF attacks are enabled by default for all the applications that are built into the product. Therefore, you need to apply these configurations manually, only if you have any custom applications deployed in your product. 
>>>>>>>> 5.9.0-docs-old:en/identity-server/5.9.0/docs/administer/mitigating-cross-site-request-forgery-attacks.md
