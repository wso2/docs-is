...
The redirection page for single sign-on (SSO) is available at `<IS_HOME>/repository/resources/identity/pages/samlsso_response.html`. Edit this HTML file to re-brand the SSO redirection page.
