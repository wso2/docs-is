# Identity Application Management API

The Identity Application Management API can be used to add and configure service providers in [WSO2 Identity Server](https://wso2.com/identity-platform/access-manager/). The following
