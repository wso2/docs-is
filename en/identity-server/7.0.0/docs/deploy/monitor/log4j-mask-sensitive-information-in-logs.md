...
2. These patterns are configured in the `<IS_HOME>/repository/conf/wso2-log-masking.properties`. You can change its default configurations in `<IS_HOME>/repository/conf/deployment.toml`.
