...
This is to define whether to ID token encryption should be enabled or not. For a tutorial on this, see [Test OIDC Encrypted ID Token with IS]({{base_path}}/guides/authentication/oidc/oidc-token-encryption/).

----

## Enable OIDC Back-Channel Logout

This is to define whether OIDC back-channel logout should be enabled or not. For more information, see [Configure OpenID Connect Back-Channel Logout]({{base_path}}/guides/authentication/oidc/add-back-channel-logout/).
