...
??? example "PostgreSQL"
    1. Add the following configurations to the `deployment.toml` file.
        ...
        ```
    2. Navigate to `<IS_HOME>/dbscripts`. Execute the scripts of [User Management Related Tables](../../administer/user-management-related-tables) in the following file, against the database created.    
