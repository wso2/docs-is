...
7. Copy the `RecoveryEndpointConfig.properties` file from the `<IS_HOME>/repository/conf/identity` directory to the `<WEBAPP_HOME>/authenticationendpoint/WEB-INF/classes` directory.
