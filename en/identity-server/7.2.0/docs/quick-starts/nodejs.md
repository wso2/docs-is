...
<script>
  const meta = {
    ...
    source_code: "<a href='https://github.com/asgardeo-samples/asgardeo-javascript-samples/tree/main/passport-asgardeo-sample' target='_blank' class='github-icon'>WSO2 IS Express.js Sample</a>"
  };
</script>
