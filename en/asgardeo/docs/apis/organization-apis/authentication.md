...
To access organization APIs in {{ product_name }}, you must first get an access token from your organization for the relevant API operations.

The following is a high-level diagram on how to obtain authorization for organization APIs.
