...
Follow the steps given below to register the sample React SPA in WSO2 Identity Platform.
...
<div class="centered-container">
  <div class="border-text">
    <img class="skip-glightbox" src="{{base_path}}/assets/img/logo/react-logo.svg" alt="React" width=50><br>
   ...
   <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <p>Learn more about [OIDC scopes in WSO2 Identity Platform]({{base_path}}/guides/users/attributes/manage-scopes/).</p>
        </td>
      </tr>
    </tbody>
    </table>
...
3. Click **Login**. You will be redirected to the WSO2 Identity Platform login page.
