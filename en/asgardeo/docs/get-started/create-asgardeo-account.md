...
2. Enter your email address and click **Register**. You will receive an email with instructions on how to complete your account creation.
    ...
    ![Sign up to WSO2 Identity Platform]({{base_path}}/assets/img/get-started/sign-up-to-asgardeo.png){: width="700" style="display: block; margin: 0; border: 0.3px solid lightgrey;"}
...
!!! note
    Users can also manage their own accounts from the WSO2 Identity Platform self-service portal. Learn more about [user self-service]({{base_path}}/guides/user-self-service/).

## What's next?

Now that you've set up your own organization and created your first user, you can:

1. Use a test application to quickly try out WSO2 Identity Platform. See [Try login with WSO2 Identity Platform]({{base_path}}/get-started/try-it-application/).
2. Set up WSO2 Identity Platform in your application or in a sample application. See [Start integrating WSO2 Identity Platform into applications]({{base_path}}/get-started/start-integrating-apps/).
