...
You need to have a WSO2 Identity Platform account. If you do not have one, create one for free in [WSO2 Identity Platform](https://asgardeo.io/signup){: target="_blank"}. Follow the [documentation]({{base_path}}/get-started/) to learn how to get started.
