...
See the topics listed below for end-to-end tutorials on how to use WSO2 Identity Platform with different technologies and different use cases.
...
- [Authenticate Agents with WSO2 Agent ID to Claude API Using Workload Identity Federation]({{base_path}}/tutorials/agent-id-claude-authentication/)
