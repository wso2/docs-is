...
- (Recommended) Configure strong authentication for WSO2 Identity Platform administrator users. [Learn more]({{base_path}}/guides/your-identity-platform/identity-platform-self-service/#enroll-totp-for-wso2-identity-platform-users)
