...
<script>
  const meta = {
    what_you_will_learn: [
      "Build an AI agent using Crew AI",
    ...
    source_code: "<a href='https://github.com/wso2/iam-ai-samples/tree/main/agent-identity/python'' target='_blank' class='github-icon'>Crew AI Python Sample</a>"
  };
</script>

{% include "../../../includes/quick-starts/crew-ai-py.md" %}
