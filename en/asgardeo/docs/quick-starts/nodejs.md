...
<script>
  const meta = {
    what_you_will_learn: [
      ...
      "Install Passport WSO2 Identity Platform strategy <a href='https://www.npmjs.com/package/@asgardeo/passport-asgardeo' target='_blank' rel='noopener noreferrer'>@asgardeo/passport-asgardeo</a>",
    ...
    source_code: "<a href='https://github.com/asgardeo-samples/asgardeo-javascript-samples/tree/main/passport-asgardeo-sample' target='_blank' class='github-icon'>WSO2 Identity Platform Node.js Sample</a>"
  };
</script>
