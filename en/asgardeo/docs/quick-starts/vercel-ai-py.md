...
<script>
  const meta = {
    ...
    source_code: "<a href='https://github.com/wso2/iam-ai-samples/tree/main/agent-identity/python'' target='_blank' class='github-icon'>Vercel AI Python Sample</a>"
  };
</script>

{% include "../../../includes/quick-starts/vercel-ai-py.md" %}
