...
If you are on the free subscription, the MAU count will be throttled when the limit is exceeded. However, for higher subscription plans, additional MAUs will not be throttled but charged as specified in the [WSO2 Identity Platform pricing](https://wso2.com/asgardeo/pricing/) page.
...
!!! note
    To compare the different subscription plans, go to [WSO2 Identity Platform pricing](https://wso2.com/asgardeo/pricing/).
