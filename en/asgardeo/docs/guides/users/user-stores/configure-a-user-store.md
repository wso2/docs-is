...
4. Click **Next** and under **Map Attributes**, map **Username** and **User ID** attributes to that of your user store.
    ...
    !!! warning
        ...
        Additionally, for Non-JDBC user stores, ensure that multiple email addresses and mobile numbers attributes are properly configured by following the instructions in the [Managing multiple email addresses and mobile numbers]({{base_path}}/guides/users/attributes/manage-attributes/#managing-multiple-email-addresses-and-mobile-numbers) section.
