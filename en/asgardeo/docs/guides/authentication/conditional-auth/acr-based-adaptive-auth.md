...
=== "Sample request"
    ...
    &response_type=code
    &redirect_uri=https://myapp.io/login
...
!!! warning
    {{ product_name }} authentication script does not support the `Comparison` attribute in the `RequestedAuthnContext` element due to the following reasons:
