...
Organization applications can be created by using the {{ product_name }} Console. You can switch to the organization from the Organization tab and in the organization's console, go to the Applications tab and you can create OAuth2 applications.
