...
1. Login to your organization using the link `https://{{console_host_name}}/t/{{ root_organization_path_param | default('{root-organization-name}') }}/o/{organization-id}{{console_path}}`.
