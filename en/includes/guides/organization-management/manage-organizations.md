...
!!! note "Before you begin"
    ...
    - [Define your primary business organization]({{base_path}}/guides/your-identity-platform/manage-root-organizations/).
...
3. In the **Add Organization** dialog box that opens, enter a name and description for your organization.
    ...
    {% if product_name != "WSO2 Identity Platform" and (product_name == "WSO2 Identity Server" and is_version > "7.1.0") %}
    !!! note
