...
!!! warning
    You need a paid {{ product_name }} subscription to use this feature. If you don't already have one, view the available [subscription plans](https://wso2.com/identity-platform/pricing/){:target="_blank"} and contact the {{ product_name }} sales team.
