...
!!! note "UI Branding for B2B applications"
    If you have created [suborganizations]({{base_path}}/guides/organization-management/manage-suborganizations/), note that you can configure seperate UI branding for your suborganizations, if you have not configure UI branding for your suborganization, the UI branding of your root organization will be applied to the suborganization.
