...
!!! tip
    Utilize the [sample pre-update password extension](https://github.com/asgardeo-samples/asgardeo-service-extension-samples/tree/main/pre-update-password-extension-samples) to understand how to validate passwords against a compromised password list and how to handle the response appropriately.
