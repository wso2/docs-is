The {{product_name}} triggers the pre-update password action version v1.x during the following flows involving password updates.
...
- [pre-update password API contract v1.0]({{base_path}}/references/service-extensions/pre-flow-extensions/pre-update-password-action/api-contract#pre-update-password-v1.0)
- [pre-update password API contract v1.1]({{base_path}}/references/service-extensions/pre-flow-extensions/pre-update-password-action/api-contract#pre-update-password-v1.1)
...
<tr class="odd">
<td>event</td>
<td><p>Contains context information relevant to password update flow. Refer <a href="#event">event</a> section for details.</p></td>
</tr>
</tbody>
</table>
