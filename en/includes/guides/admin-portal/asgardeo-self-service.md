...
If you are an owner or an administrator in an {{ product_name }} organization, go to the [My Account portal](#access-my-account-portal) to manage your information from anywhere.
