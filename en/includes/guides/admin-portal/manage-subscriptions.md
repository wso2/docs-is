...
See the [pricing details](https://wso2.com/identity-platform/pricing/){:target="_blank"} and the available resource limits and usage limits for each subscription plan.
...
4. Once you have evaluated the subscription details, you can do one of the following:
    ...
    - **Subscribe to an Essentials or a Professional plan** by following the steps below:
        ...
        2. Enter your billing and payment details and agree to our [terms of fees and payment](https://wso2.com/identity-platform/terms-of-use/#fees-and-payment){:target="_blank"}
...
If you are on the free subscription, the MAU count will be throttled when the limit is exceeded. However, for higher subscription plans, additional MAUs will not be throttled but charged as specified in the [{{ product_name }} pricing](https://wso2.com/identity-platform/pricing/){:target="_blank"} page.
...
!!! note
    To compare the different subscription plans, go to [{{ product_name }} pricing](https://wso2.com/identity-platform/pricing/){:target="_blank"}.
