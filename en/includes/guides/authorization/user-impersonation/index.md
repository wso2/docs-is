...
If the impersonator is a shared user (a user whose profile is managed by a parent organization), see [Impersonation for shared users]({{base_path}}/guides/organization-management/shared-user-impersonation).
