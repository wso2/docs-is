...
![Reset Password]({{base_path}}/assets/img/guides/organization/account-security/password-validation/reset-password.png){: width="800" style="display: block; margin: 0; border: 0.3px solid lightgrey;"}
