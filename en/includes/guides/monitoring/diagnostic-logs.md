...
![{{ product_name }} logs]({{base_path}}/assets/img/guides/asgardeo-logs/diagnostic-logs-display.png)
...
![{{ product_name }} logs filter by time]({{base_path}}/assets/img/guides/asgardeo-logs/logs-filter-by-time.png)
...
3. Click the button to submit.
    ...
    ![{{ product_name }} logs filter by custom time range]({{base_path}}/assets/img/guides/asgardeo-logs/logs-select-custom-time-range.png)
...
![{{ product_name }} logs search bar]({{base_path}}/assets/img/guides/asgardeo-logs/logs-search-bar.png)

### Filter logs

When you expand a log in {{ product_name }} by clicking on it, you will get the following view.

![{{ product_name }} logs expanded view]({{base_path}}/assets/img/guides/asgardeo-logs/asgardeo-log-expand-view.png)
...
![{{ product_name }} logs filter by specific value]({{base_path}}/assets/img/guides/asgardeo-logs/logs-filter-by-specific-value.png)
...
![Info logs in conditional authentication]({{base_path}}/assets/img/guides/asgardeo-logs/info-log-conditional-auth.png)
...
![Debug logs in conditional authentication]({{base_path}}/assets/img/guides/asgardeo-logs/debug-log-conditional-auth.png)
...
- Application errors that occur due to syntax errors in the conditional authentication script.
    ...
    ![Error logs due to syntax in conditional authentication]({{base_path}}/assets/img/guides/asgardeo-logs/error-log-syntax-error-conditional-auth.png)
...
- Custom errors that you define using the utility function `Log.error()`.
   ...
   executeStep(1, {
    ...
    ![Error logs in conditional authentication]({{base_path}}/assets/img/guides/asgardeo-logs/error-log-conditional-auth.png)
...
3. Go to the logs portal on the {{ product_name }} Console and observe the following error log.
    ...
    ![{{ product_name }} logs invalid credentials]({{base_path}}/assets/img/guides/asgardeo-logs/logs-invalid-credentials.png)
...
5. Go to the logs portal on the {{ product_name }} Console and observe the following error log.
    ...
    ![{{ product_name }} logs conditional authentication]({{base_path}}/assets/img/guides/asgardeo-logs/logs-conditional-authentication.png)