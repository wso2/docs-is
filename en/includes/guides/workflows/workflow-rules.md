...
## Rule fields by operation type

Each operation type supports a different set of fields that you can use to define rule conditions.
...
| Role       | `role.id`              |
| Role       | `role.audience`        |
| Role       | `role.hasAddedUsers`   |
| Role       | `role.hasDeletedUsers` |
| Initiator  | `initiator.claims`     |
