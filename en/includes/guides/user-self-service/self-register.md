...
5. If **Account Verification** is enabled, users can resend the account verification email if needed.
    - If **Activate Account Immediately** is enabled, after successfully logging into My Account, a warning message with a resend link will appear. Click this link to resend the account verification email.
    ...
    - If **Activate Account Immediately** is disabled, attempting to log in to My Account, will display a warning message indicating the account is not activated, along with a resend link. Click this link to resend the account verification email.
