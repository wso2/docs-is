...
!!! tip
    ...
    For a comprehensive list of data types and input formats, refer to the [attribute configuration reference]({{base_path}}/guides/users/attributes/user-attributes/attribute-configurations-reference/).
