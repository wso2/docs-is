...
final accounts = await Asgardeo.instance.pushAuth.getAccounts();
...
final account = await Asgardeo.instance.pushAuth.getAccount(accountId);
```
...
final account = await Asgardeo.instance.pushAuth.getAccountByDeviceId(deviceId);
```
...
final records = await Asgardeo.instance.pushAuth.getAuthHistory(accountId);
