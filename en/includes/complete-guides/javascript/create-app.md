...
At this point, you have a simple yet fully functional JavaScript app. In the next step, let’s try to integrate the JavaScript SDK of the WSO2 Identity Platform with the app. 
