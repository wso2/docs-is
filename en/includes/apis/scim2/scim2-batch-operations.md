...
!!! Info
    The default limit for bulk operations is 1,000 operations per request. To modify this limit, add the following configuration to the `<IS_HOME>/repository/conf/deployment.toml` file.
...
!!! Info
    The default limit for bulk operations is 100 operations per request.
...
<table>
    <tr>
        <th>Operation</th>
        <th>Management API Scope</th>
        <th>Organization API Scope</th>
    </tr>
    <tr>
        <td>Create Users</td>
        <td>internal_bulk_user_create</td>
        <td>internal_org_bulk_user_create</td>
    </tr>
    <tr>
        <td>Update Users</td>
        <td>internal_bulk_user_update</td>
        <td>internal_org_bulk_user_update</td>
    </tr>
    <tr>
        <td>Replace Users</td>
        <td>internal_bulk_user_update</td>
    ...
    <tr>
        ...
        <td>internal_org_bulk_user_delete</td>
    </tr>
    <tr>
        <td>Create Groups</td>
        <td>internal_bulk_group_create</td>
        <td>internal_org_bulk_group_create</td>
    </tr>
    <tr>
        <td>Update Groups</td>
        <td>internal_bulk_group_update</td>
        <td>internal_org_bulk_group_update</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>internal_org_bulk_group_delete</td>
    </tr>
    <tr>
        <td>Create Roles</td>
        <td>internal_bulk_role_create</td>
        <td>internal_org_bulk_role_create</td>
    </tr>
    <tr>
        <td>Update Roles</td>
        <td>internal_bulk_role_update</td>
        <td>internal_org_bulk_role_update</td>
    </tr>
    <tr>
        <td>Replace Roles</td>
        <td>internal_bulk_role_update</td>
    ...
    <tr>
        ...
        <td>internal_org_bulk_role_delete</td>
    </tr>
</table>
