...
Follow the topics given below to understand how **Patch** operations can be used when you invoke the SCIM2 [User PATCH operation]({{base_path}}/apis/scim2/scim2-users-rest-api/#tag/Users-Endpoint/operation/patchUser), [Group PATCH operation]({{base_path}}/apis/scim2/scim2-groups-rest-api/#tag/Groups-Endpoint/operation/patchGroup), {% if product_name == "WSO2 Identity Server" %}[Role PATCH operation]({{base_path}}/apis/roles-v2-rest-api/#tag/Roles-Endpoint/operation/patchRole){% else %}[Role PATCH operation]({{base_path}}/apis/role-management/roles/#tag/Roles-Endpoint/operation/patchRole){% endif %} and {% if product_name == "WSO2 Identity Server" %}[Me PATCH operation]({{base_path}}/apis/scim2-me-rest-apis/#tag/Me-Endpoint/operation/patchUserMe){% else %}[Role PATCH operation]({{base_path}}/apis/scim2-me/#tag/Me-Endpoint/operation/patchUserMe){% endif %}.
