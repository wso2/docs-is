...
* {% if product_name == "WSO2 Identity Platform" %}An [**WSO2 Identity Platform account**](https://wso2.com/asgardeo/docs/get-started/create-identity-platform-account/){% else %}An [**Identity Server**](https://wso2.com/identity-server/){% endif %}
